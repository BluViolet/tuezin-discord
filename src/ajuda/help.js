...
exports.run = (bot, msg, args) => {
    ...
    if (!args[0]) {
        ...
        embed.setDescription(`Olá, sou **${bot.user.username}** estou feliz para poder participar do seu servidor! Me adicione [aqui](https://discord.com/oauth2/authorize?=&client_id=807122748223782912&scope=bot&permissions=8) ficarei muito grata! ❤️\n\n<:aviso:686628220333981700> Temos no total de \`${bot.commands.size}\` comandos para você explorar!`)
        ...
        embed.addField(`Você gosta das minhas funções?`, `Clique [aqui](https://discord.com/oauth2/authorize?=&client_id=807122748223782912&scope=bot&permissions=8) para me adicionar no seu servidor.`)
        embed.setColor(`#6800e5`)
        embed.setFooter(`Versão atual: 3.0.3`)
