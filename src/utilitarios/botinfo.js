...
let prefix = prefixes[message.guild.id].prefixes;
        ...
        embed.setDescription(`🛠️ Olá sou a **${bot.user.username}**, sou um Bot simples focado em deixar seu servidor com diversão! Tenho várias funcionalidades, fui desenvolvido(a) em **Visual Studio Code**, **📚 Discord.js** (JavaScript).\nSempre estou inovando meus comandos, e sempre tentando dar o melhor de mim!\nCaso queria saber mais dos meus comandos, basta digitar **${prefix}help** para mais informações.`)
