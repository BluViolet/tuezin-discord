// Bot desenvolvido por @felip.rei and @brunin062
// Não remova os creditos
...
bot.on('ready', () => {
    ...
    console.log(`Usuários: ${bot.users.size} | Canais: ${bot.channels.size} | Servidores: ${bot.guilds.size}`)
     let status = [
         {name: `em ${bot.users.size} jogadores`, type: 'STREAMING', url: 'https://twitch.tv/tuezinbot'},
         {name: `em ${bot.guilds.size} servidores`, type: 'STREAMING', url: 'https://twitch.tv/tuezinbot'},
         {name: `em ${bot.channels.size} canais`, type: 'STREAMING', url: 'https://twitch.tv/tuezinbot'},
         {name: `Me adicione, e aproveite + de 80 comandos sem premium!`, type: 'STREAMING', url: 'https://twitch.tv/tuezinbot'},
         {name: `Você sabia que eu sou open-source? acesse https://github.com/feliprei/tuezin-discord`, type: 'STREAMING', url: 'https://twitch.tv/tuezinbot'}
 ...
 bot.on('guildMemberAdd', members => {
     ...
     let embed = new Discord.RichEmbed()
      ...
      .addField(`Você gosta das minhas funções?`, `Me adicione [clicando aqui!](https://discord.com/oauth2/authorize?=&client_id=807122748223782912&scope=bot&permissions=8)`, true)
      .setTimestamp()
